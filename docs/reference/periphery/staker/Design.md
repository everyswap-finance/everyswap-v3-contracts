...
The liquidity mining staker design is comprised of one canonical position staking contract, Staker. The technical reference for this contract is [here](...md) and the source code is [here](https://github.com/Uniswap/uniswap-v3-staker).
